...
export function WelcomeScreen({ onStart }) {
  return (
    <div className="text-center space-y-6">
      ...
      <h1 className="mb-64 text-4xl font-bold text-primary font-title">Secret Santa</h1>
      ...
      <button onClick={onStart} className="button pt-2 pr-16  pb-2 pl-16 text-lg text-white px-8 py-3 font-title bg-primary border rounded-3xl">
        Commencer !
      </button>
    </div>
  );
